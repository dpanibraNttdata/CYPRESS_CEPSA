        ...
        cy.fixture('lubricantes').then((config) => {
            ...
            cy.visit(config.URL, {
                onLoad: () => {
                    ...
                    cy.get('tbody > :nth-child(2) > :nth-child(7) > a').click({ multiple: true });

                    cy.get(':nth-child(3) > :nth-child(5) > .d-flex > #order-amount').type(15);
                    cy.get('tbody > :nth-child(3) > :nth-child(7) > a').click({ multiple: true });

                    cy.get(':nth-child(4) > :nth-child(5) > .d-flex > #order-amount').type(20);
                    cy.get('tbody > :nth-child(4) > :nth-child(7) > a').click({ multiple: true });
